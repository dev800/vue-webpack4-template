...
export default {
  ...
  methods: {
    ...
    getColumnFmIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn('[Fmement Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.')
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnFmIndex(children, this.$el)
