<template>
  <div class="x-app-aside">
    <h5>默认颜色</h5>
    <fm-menu
      default-active="2"
      class="fm-menu-vertical-demo"
...
export default {
  components: {
    'fm-menu': FmMenu,
    'fm-submenu': FmSubmenu,
    'fm-menu-item': FmMenuItem,
    'fm-menu-item-group': FmMenuItemGroup
  }
}
</script>
