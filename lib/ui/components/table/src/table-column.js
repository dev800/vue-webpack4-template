...
export default {
  ...
  methods: {
    ...
    getColumnUiIndex (children, child) {
    ...
    setColumnRenders (column) {
      ...
      if (this.renderHeader) {
        console.warn('[Uiement Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.')
  ...
  mounted () {
    ...
    const columnIndex = this.getColumnUiIndex(children, this.$el)
