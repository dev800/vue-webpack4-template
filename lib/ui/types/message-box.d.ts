...
export declare class UIMessageBoxComponent extends Vue {
  title: string
  message: string
  type: MessageType
  iconClass: string
...
export interface UIMessageBoxOptions {
  ...
  callback?: (action: MessageBoxCloseAction, instance: UIMessageBoxComponent) => void

  /** Callback before MessageBox closes, and it will prevent MessageBox from closing */
  beforeClose?: (action: MessageBoxCloseAction, instance: UIMessageBoxComponent, done: (() => void)) => void
...
export interface UIMessageBoxShortcutMethod {
  (message: string, title: string, options?: UIMessageBoxOptions): Promise<MessageBoxData>
  (message: string, options?: UIMessageBoxOptions): Promise<MessageBoxData>
}

export interface UIMessageBox {
  /** Show a message box */
  (message: string, title?: string, type?: string): Promise<MessageBoxData>

  /** Show a message box */
  (options: UIMessageBoxOptions): Promise<MessageBoxData>

  /** Show an alert message box */
  alert: UIMessageBoxShortcutMethod

  /** Show a confirm message box */
  confirm: UIMessageBoxShortcutMethod

  /** Show a prompt message box */
  prompt: UIMessageBoxShortcutMethod

  /** Set default options of message boxes */
  setDefaults (defaults: UIMessageBoxOptions): void
